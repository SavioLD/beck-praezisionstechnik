...
-- Storage-Bucket für den optionalen Lebenslauf-Upload
-- ---------------------------------------------------------------------
-- Einmalig im Supabase SQL-Editor des Beck-Projekts ausführen.
...
-- (In index.html zusätzlich SUPABASE_URL + SUPABASE_KEY eintragen.)
--
-- Sicherheit:
